<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("_evaluacion");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid _evaluacion");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: IngresoSolicitud.evaluarBeneficios
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">_evaluacion</label>
                            		<div class="div_checkbox">
                              		<input name="_evaluacion" type="checkbox" class="checkbox" id="_evaluacion" value="${_evaluacion}" />
                            		</div>
